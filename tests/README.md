...
|---|---|---|
| `test:engine` | nothing | The document engine, in-process. Ordering, merge, idempotency, the revision gate, undo inversion, totals. |
...
| `test:ui` | server + Chromium | A real browser. Editing, saving, undo/redo, the approval card, the phone layout. |
